...
fn main() {
    ...
    cg_recap::texture_parameter(gl::TEXTURE_CUBE_MAP, gl::TEXTURE_WRAP_S, gl::CLAMP_TO_EDGE);
    cg_recap::texture_parameter(gl::TEXTURE_CUBE_MAP, gl::TEXTURE_WRAP_T, gl::CLAMP_TO_EDGE);
    cg_recap::texture_parameter(gl::TEXTURE_CUBE_MAP, gl::TEXTURE_WRAP_R, gl::CLAMP_TO_EDGE);
    ...
    for target in gl::TEXTURE_CUBE_MAP_POSITIVE_X..=gl::TEXTURE_CUBE_MAP_NEGATIVE_Z {
        unsafe {
            gl::TexImage2D(target, 0, gl::RGBA8 as i32, res, res, 0, gl::RGBA, gl::UNSIGNED_BYTE, std::ptr::null());
        }
    ...
    while !window.should_close() {
        ...
        let rotations = [
            ...
            // back
            glm::look_at(&reflective_object_pos, &glm::vec3(0.0, 0.0, 1.0), &glm::vec3(0.0, -1.0, 0.0)),
            // glm::rotation(180.0_f32.to_radians(), &glm::Vec3::y_axis()),
        ];
        cg_recap::bind_framebuffer(framebuffer, gl::FRAMEBUFFER);
        cg_recap::bind_texture(env_map, gl::TEXTURE_CUBE_MAP);
        cg_recap::viewport(0, 0, res, res);
        ...
        cg_recap::clear(gl::DEPTH_BUFFER_BIT);
        cg_recap::viewport(0, 0, width as i32, height as i32);
